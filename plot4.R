...
par(mfcol=c(2,2))
# Plot1
plot(housholdpowerdata$DateTime, housholdpowerdata$Global_active_power, type = "l", xlab = "",ylab ="Global Active Power" )
#Plot2
...
#Plot3
plot(housholdpowerdata$DateTime, housholdpowerdata$Voltage, type = "l", xlab = "datetime",ylab ="Voltage" )

#Plot4
plot(housholdpowerdata$DateTime, housholdpowerdata$Global_reactive_power, type = "l", xlab = "datetime",ylab ="Global_reactive_power" )
